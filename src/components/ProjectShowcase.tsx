...
function Image({ project }: { project: Project }) { return <a className="project-image" aria-label={`Open ${project.name} project`} href={project.url} target="_blank" rel="noopener noreferrer"><img src={project.image} alt={project.name} loading="lazy" onError={(event) => { event.currentTarget.style.visibility = 'hidden'; }} /><span className="image-cta">OPEN ↗</span></a>; }
